...
#   define _Inout_opt_
#   define _In_opt_
#   define MCGEN_DISABLE_PROVIDER_CODE_GENERATION
...
#if defined _MSC_VER
#   define EXPORT_SELECT_ANY __declspec(selectany)
#else
#   define EXPORT_SELECT_ANY
#endif

EXTERN_C EXPORT_SELECT_ANY const GUID LibOVRProvider = {0x553787fc, 0xd3d7, 0x4f5e, {0xac, 0xb2, 0x15, 0x97, 0xc7, 0x20, 0x9b, 0x3c}};
...
// Event Descriptors
//
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR Call = {0x0, 0x0, 0x11, 0x4, 0xa, 0x1, 0x4000000000000000};
#define Call_value 0x0
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR Return = {0x1, 0x0, 0x11, 0x4, 0xb, 0x1, 0x4000000000000000};
#define Return_value 0x1
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR Waypoint = {0x2, 0x0, 0x10, 0x4, 0xc, 0x1, 0x8000000000000000};
#define Waypoint_value 0x2
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR DistortionBegin = {0x4, 0x0, 0x11, 0x4, 0xd, 0x2, 0x4000000000000000};
#define DistortionBegin_value 0x4
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR DistortionWaitGPU = {0x5, 0x0, 0x11, 0x4, 0xe, 0x2, 0x4000000000000000};
#define DistortionWaitGPU_value 0x5
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR DistortionPresent = {0x6, 0x0, 0x11, 0x4, 0xf, 0x2, 0x4000000000000000};
#define DistortionPresent_value 0x6
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR DistortionEnd = {0x7, 0x0, 0x11, 0x4, 0x10, 0x2, 0x4000000000000000};
#define DistortionEnd_value 0x7
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR HmdDesc_v0 = {0x8, 0x0, 0x11, 0x4, 0x11, 0x3, 0x4000000000000000};
#define HmdDesc_v0_value 0x8
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR HmdDesc = {0x8, 0x1, 0x11, 0x4, 0x11, 0x3, 0x4000000000000000};
#define HmdDesc_value 0x8
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR CameraFrameReceived_v0 = {0x9, 0x0, 0x11, 0x4, 0x12, 0x4, 0x4000000000000000};
#define CameraFrameReceived_v0_value 0x9
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR CameraFrameReceived = {0x9, 0x1, 0x11, 0x4, 0x12, 0x4, 0x4000000000000000};
#define CameraFrameReceived_value 0x9
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR CameraBeginProcessing_v0 = {0xa, 0x0, 0x11, 0x4, 0xd, 0x4, 0x4000000000000000};
#define CameraBeginProcessing_v0_value 0xa
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR CameraBeginProcessing = {0xa, 0x1, 0x11, 0x4, 0xd, 0x4, 0x4000000000000000};
#define CameraBeginProcessing_value 0xa
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR CameraFrameRequest = {0xb, 0x0, 0x11, 0x4, 0x13, 0x4, 0x4000000000000000};
#define CameraFrameRequest_value 0xb
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR CameraEndProcessing_v0 = {0xc, 0x0, 0x11, 0x4, 0x10, 0x4, 0x4000000000000000};
#define CameraEndProcessing_v0_value 0xc
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR CameraEndProcessing = {0xc, 0x1, 0x11, 0x4, 0x10, 0x4, 0x4000000000000000};
#define CameraEndProcessing_value 0xc
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR CameraSkippedFrames_v0 = {0xd, 0x0, 0x11, 0x4, 0xc, 0x4, 0x4000000000000000};
#define CameraSkippedFrames_v0_value 0xd
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR CameraSkippedFrames = {0xd, 0x1, 0x11, 0x4, 0xc, 0x4, 0x4000000000000000};
#define CameraSkippedFrames_value 0xd
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR JSONChunk = {0xe, 0x0, 0x11, 0x4, 0xc, 0x3, 0x4000000000000000};
#define JSONChunk_value 0xe
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR LogDebugMessage = {0xf, 0x0, 0x10, 0x5, 0xc, 0x5, 0x8000000000000000};
#define LogDebugMessage_value 0xf
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR LogInfoMessage = {0x10, 0x0, 0x11, 0x4, 0xc, 0x5, 0x4000000000000000};
#define LogInfoMessage_value 0x10
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR LogErrorMessage = {0x11, 0x0, 0x12, 0x2, 0xc, 0x5, 0x2000000000000000};
#define LogErrorMessage_value 0x11
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR HmdTrackingState = {0x12, 0x0, 0x11, 0x4, 0xc, 0x3, 0x4000000000000000};
#define HmdTrackingState_value 0x12
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR CameraBlobs_v0 = {0x13, 0x0, 0x11, 0x4, 0xc, 0x4, 0x4000000000000000};
#define CameraBlobs_v0_value 0x13
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR CameraBlobs = {0x13, 0x1, 0x11, 0x4, 0xc, 0x4, 0x4000000000000000};
#define CameraBlobs_value 0x13
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR CameraBeginGlobalImageAquisition = {0x14, 0x0, 0x11, 0x4, 0xd, 0x4, 0x4000000000000000};
#define CameraBeginGlobalImageAquisition_value 0x14
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR CameraEndGlobalImageAquisition = {0x15, 0x0, 0x11, 0x4, 0x10, 0x4, 0x4000000000000000};
#define CameraEndGlobalImageAquisition_value 0x15
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR BeginCameraLEDMatching = {0x16, 0x0, 0x11, 0x4, 0xd, 0x4, 0x4000000000000000};
#define BeginCameraLEDMatching_value 0x16
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR EndCameraLEDMatching = {0x17, 0x0, 0x11, 0x4, 0x10, 0x4, 0x4000000000000000};
#define EndCameraLEDMatching_value 0x17
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR CameraPoseChange = {0x18, 0x0, 0x11, 0x4, 0xd, 0x4, 0x4000000000000000};
#define CameraPoseChange_value 0x18
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR CameraClockSync = {0x19, 0x0, 0x11, 0x4, 0x10, 0x4, 0x4000000000000000};
#define CameraClockSync_value 0x19
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR CameraPoseReconstruction = {0x1a, 0x0, 0x11, 0x4, 0xd, 0x4, 0x4000000000000000};
#define CameraPoseReconstruction_value 0x1a
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR CameraPoseSensorFusion = {0x1b, 0x0, 0x11, 0x4, 0xd, 0x4, 0x4000000000000000};
#define CameraPoseSensorFusion_value 0x1b
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR CameraGetFrame = {0x1c, 0x0, 0x11, 0x4, 0x13, 0x4, 0x4000000000000000};
#define CameraGetFrame_value 0x1c
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR CameraBeginBlobSegmentation = {0x1d, 0x0, 0x11, 0x4, 0xd, 0x4, 0x4000000000000000};
#define CameraBeginBlobSegmentation_value 0x1d
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR PoseLatchCPUWrite = {0x1e, 0x0, 0x11, 0x4, 0xd, 0x2, 0x4000000000000000};
#define PoseLatchCPUWrite_value 0x1e
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR PoseLatchGPULatchReadback = {0x1f, 0x0, 0x11, 0x4, 0x10, 0x2, 0x4000000000000000};
#define PoseLatchGPULatchReadback_value 0x1f
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR QueueAheadDelayBegin = {0x20, 0x0, 0x11, 0x4, 0xd, 0x6, 0x4000000000000000};
#define QueueAheadDelayBegin_value 0x20
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR QueueAheadDelayEnd = {0x21, 0x0, 0x11, 0x4, 0x10, 0x6, 0x4000000000000000};
#define QueueAheadDelayEnd_value 0x21
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR HmdDisplay = {0x22, 0x0, 0x11, 0x4, 0x11, 0x3, 0x4000000000000000};
#define HmdDisplay_value 0x22
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR VSync = {0x23, 0x0, 0x11, 0x4, 0xf, 0x2, 0x4000000000000000};
#define VSync_value 0x23
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR AppCompositorFocus = {0x24, 0x0, 0x11, 0x4, 0xc, 0x5, 0x4000000000000000};
#define AppCompositorFocus_value 0x24
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR AppConnect = {0x25, 0x0, 0x11, 0x4, 0xc, 0x5, 0x4000000000000000};
#define AppConnect_value 0x25
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR AppDisconnect = {0x26, 0x0, 0x11, 0x4, 0xc, 0x5, 0x4000000000000000};
#define AppDisconnect_value 0x26
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR AppNoOp = {0x27, 0x0, 0x11, 0x4, 0xc, 0x5, 0x4000000000000000};
#define AppNoOp_value 0x27
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR PosePrediction = {0x28, 0x0, 0x11, 0x4, 0xd, 0x7, 0x4000000000000000};
#define PosePrediction_value 0x28
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR LatencyTiming = {0x29, 0x0, 0x11, 0x4, 0xc, 0x5, 0x4000000000000000};
#define LatencyTiming_value 0x29
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR EndFrameAppTiming = {0x2a, 0x0, 0x11, 0x4, 0xc, 0x5, 0x4000000000000000};
#define EndFrameAppTiming_value 0x2a
EXTERN_C EXPORT_SELECT_ANY const EVENT_DESCRIPTOR HardwareInfo = {0x2b, 0x0, 0x11, 0x4, 0x0, 0x0, 0x4000000000000000};
...
EXTERN_C EXPORT_SELECT_ANY DECLSPEC_CACHEALIGN ULONG OVR_SDK_LibOVREnableBits[1];
EXTERN_C EXPORT_SELECT_ANY const ULONGLONG OVR_SDK_LibOVRKeywords[4] = {0x4000000000000000, 0x8000000000000000, 0x8000000000000000, 0x2000000000000000};
EXTERN_C EXPORT_SELECT_ANY const UCHAR OVR_SDK_LibOVRLevels[4] = {4, 4, 5, 2};
EXTERN_C EXPORT_SELECT_ANY MCGEN_TRACE_CONTEXT LibOVRProvider_Context = {0, 0, 0, 0, 0, 0, 0, 0, 4, OVR_SDK_LibOVREnableBits, OVR_SDK_LibOVRKeywords, OVR_SDK_LibOVRLevels};

EXTERN_C EXPORT_SELECT_ANY REGHANDLE OVR_SDK_LibOVRHandle = (REGHANDLE)0;
